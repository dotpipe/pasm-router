...
class PASM 
{
    ...
    public static function get () {    // Useful for some testing
    ...
    public static function fdiv()                  // divide ST0 into $ecx
    {
        ...
        else if (!is_numeric(PASM::$ecx) || !PASM::$stack[array_key_last(PASM::$stack)])
            return new static;
    ...
    public static function end() {     // reset all command chains
        PASM::$chain = [];
        PASM::$args = array();
        PASM::$lop = 0;
        PASM::$counter = 0;
    ...
    */
    ...
    public static function run() {     // run file on linux $ST0 is command and arguments are $string
    ...
    public static function run_pop() {     // same as above but pop
    ...
    public static function stack_func() {  // do top of stack as function
        $method_del = explode("::", __METHOD__);
        PASM::$chain[] = $method_del[1];
        PASM::${$ST0}();
    ...
    public static function stack_func_pos() {  // sync stack pointer
        PASM::$sp = current(PASM::$stack);
        $method_del = explode("::", __METHOD__);
        PASM::$chain[] = $method_del[1];
        PASM::${$sp}();
